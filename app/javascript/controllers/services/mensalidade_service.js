export class MensalidadeService {
  ...
  async confirmarPagamento() {
    ...
    try {
      ...
      // Verifica se existe 'success' ou se 'status' é 'success'
      if (data.success || data.status === 'success') {
        
        // CORREÇÃO DO "UNDEFINED":
        // Tenta ler 'message', depois 'mensagem', e se nada existir, usa o texto padrão.
        ...
        // Mesma lógica de fallback para mensagens de erro
